...
const App = () => {
    ...
    const [isSourceAllValuesExpanded, setIsSourceAllValuesExpanded] = useState(false);
    const [isTargetAllValuesExpanded, setIsTargetAllValuesExpanded] = useState(false);
        ...
        return (
            <ul className="nested-menu">
                {nodes.map((node, index) => {
                    ...
                    const uniqueKey = `${parentKey}-${node.id}-${index}`;
    ...
    const generateJson = async () => {
        const payload = {
            fieldId: sourceFieldId.split(".")?.pop(),
            targetFieldId,
            rootPath: sourceFieldId,
            ruleId,
        };
    ...
    // Recursive function to filter nodes and their children based on search term
    const filterNodesRecursively = (nodes, searchTerm) => {
        return nodes
            .map((node) => {
                const filteredChildren = filterNodesRecursively(node.children || [], searchTerm);
                if (
    ...
    return (
        <div>
                ...
                <div>
                    ...
                    {isSourceAllValuesExpanded && (
                        <div className="nested-menu-wrapper">
                            {renderTreeMenu(
                                filterNodesRecursively(isSwapped ? targetTree : sourceTree, sourceSearchTerm),
            ...
            {/* Target Field Dropdown with Search */}
            <div className="dropdown-container">
                ...
                <div>
                    ...
                    {isTargetAllValuesExpanded && (
                        <div className="nested-menu-wrapper">
                            {renderTreeMenu(
                                filterNodesRecursively(isSwapped ? sourceTree : targetTree, targetSearchTerm),
